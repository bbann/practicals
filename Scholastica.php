...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $update = true;
    $records = mysqli_query($db, "SELECT * FROM saint_scholastica WHERE item=$item");
...
?>
<!--sample code from boostrapmade templates-->
<!DOCTYPE html>
<html>

<head>
    <meta charset="UTF-8">
    <title>Dormitory Item Manager</title>
...
<body>
    ...
    <!-- <?php $results = mysqli_query($db, "SELECT * FROM Saint_Scholastica"); ?> -->
